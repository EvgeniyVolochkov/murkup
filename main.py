...
async def button_1_click(message: types.Message):
    await bot.send_photo(message.chat.id, photo='https://avatars.mds.yandex.net/get-entity_search/2487574/434829330/orig', caption='Кот', reply_markup= get_keyboard_1())

@dp.message_handler(lambda message: message.text == 'Отправь фото машины')
async def button_3_click(message: types.Message):
    await bot.send_photo(message.chat.id, photo='https://autovogdenie.ru/wp-content/uploads/2022/05/foto-m4-csl_01.jpg', caption='Машина', reply_markup=get_keyboard_2())
